...
LABELS_TOPICS = ('Excited', 'Tender', 'Scared', 'Angry', 'Sad', 'Happy',)
# 'Ecstatic', 'Energetic', 'Aroused', 'Bouncy', 'Nervous',     
# 'Perky', 'Antsy', 'Intimate', 'Loving', 'Warm-hearted',      
# 'Sympathetic', 'Touched', 'Kind', 'Soft', 'Tense',           
# 'Nervous', 'Anxious', 'Jittery', 'Frightened',               
# 'Panic-stricken', 'Terrified', 'Irritated', 'Resentful',     
# 'Miffed', 'Upset', 'Mad', 'Furious', 'Raging', 'Down',       
# 'Blue', 'Mopey', 'Grieved', 'Dejected', 'Depressed',         
# 'Heartbroken', 'Fulfilled', 'Contented', 'Glad', 'Complete',
# 'Satisfied', 'Optimistic', 'Pleased')                        
